...
const Hero = () => {
  ...
  return (
    <>
        <div className='bg-custom w-full relative overflow-hidden'>
            ...
            <div className='w-full max-w-[1240px] px-6 mx-auto pt-10 sm:pt-14 pb-[300px]'>
                ...
                <div className='w-full flex items-end justify-end'>
                    <div className='md:flex hidden items-center gap-[68px] justify-end'>
                        <p className='font-semibold text-[15px] text-white leading-[32px]'>登录</p>
                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <p className='font-semibold text-[18px] text-white mb-4'>登录</p>
                            <button className='bg-[#2A9CF5] w-[216px] h-[46px] rounded-[10px] text-[#F6F9FE] text-[15px] font-semibold'>创建账户</button>
                        </motion.div>
                        )}
                    </AnimatePresence>
                ...
                <div className='mt-10 sm:mt-20 flex items-center gap-10 lg:gap-5 justify-between lg:flex-row flex-col relative z-20'>
                    <div className='w-full'>
                        <h1 className='max-w-[270px] sm:max-w-[437px] w-full font-bold text-[44px] sm:text-[72px] text-white leading-[67px] sm:leading-[110px]'> 我们有客户， 您有产品</h1>
                        <p className='lg:max-w-[534px] w-full font-normal text-[15px] sm:text-[24px] text-[#ffffff] opacity-70 mt-[19px] mb-[36px] leading-[27px] sm:leading-[45px]'>让我们来处理吧。我们为您提供所有必要的工具、无限量的客户，以及一个可以建立您业务的平台，而您只需专注于您已经擅长的事情。</p>
                        <div className='flex gap-10 sm:gap-[63px] items-center'>
                            <button className='w-[161px] sm:w-[260px] h-[28px] sm:h-[46px] border-[1.64px] rounded-[23px] font-semibold text-[11px] sm:text-[18px] text-white'>成为卖家</button>
                            <p className='text-white text-[11px] sm:text-[18px] font-semibold leading-[36px] underline underline-offset-4'>了解更多</p>
                        </div>
                    </div>
                    <div className='w-full'>
                        <AnimatedListDemo/>
